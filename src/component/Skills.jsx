        ...
        <>
            <div className='h-50 w-80 p-2 hover:scale-101 bg-white/10 backdrop-blur-lg border border-white/20 shadow-lg rounded-lg '>
                <div className='flex items-center p-1 gap-2'>
                    <div className='bg-indigo-500/20 h-10 w-10 font-bold   text-lg flex justify-center items-center rounded-sm '>
                    {logo}
                    </div>
                ...
                <div className=' flex flex-wrap mt-4'>
                    { SKILL.map((skill,id)=>(
                    <div key={id} className='bg-linear-to-r  m-1   from-indigo-400/20 to-cyan-500/20 backdrop-blur-sm border border-white/20 shadow-xl rounded-2xl hover:scale-105 h-8 w-auto flex items-center px-2 gap-2'>
